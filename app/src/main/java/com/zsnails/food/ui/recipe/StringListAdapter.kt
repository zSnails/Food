...
class StringListAdapter(private val context: Context) : RecyclerView.Adapter<StringListAdapter.InstructionViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): InstructionViewHolder {
        val holder = LayoutInflater.from(context).inflate(R.layout.ingredient_list_component, parent, false)
